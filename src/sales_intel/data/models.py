"""Pydantic models for domain entities (mirrors DuckDB schema).

These models represent the data structures stored in and retrieved from DuckDB.
They enforce type safety and validation throughout the application.
"""
